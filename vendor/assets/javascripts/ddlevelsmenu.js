...
arrowpointers:{
	downarrow: ["img/index/arrow-down.gif", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["img/index/arrow-right.gif", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
